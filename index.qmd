...
- We will officially start on Phase II after publishing PPG II at the genus level and higher
...
- There are ca. 12,000 accepted species and **60,000** synonyms 
...
- I `dwctaxon` to help edit the data from World Ferns to implement the changes we've voted on so far
...
- We plan to submit PPG II data as soon as it is ready

## Rhakhis

- WFO maintains a webb app to edit taxonomic data in the WFO database called "Rhakhis"

> called Rhakhis, a Greek form of rachis, the ‘backbone’ of a leaf or inflorescence
